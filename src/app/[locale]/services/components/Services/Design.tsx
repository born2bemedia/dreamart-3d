...
const get3DModelingServices = (t: ReturnType<typeof useTranslations>) => [
  t('services.0', { fallback: 'Landing Page Design' }),
  t('services.1', { fallback: 'Responsive Web Design' }),
  t('services.2', { fallback: 'E-commerce UI Design' }),
  t('services.3', { fallback: 'Custom Icon Design' }),
  t('services.4', { fallback: 'App Interface Design' }),
  t('services.5', { fallback: 'Dashboard Design' }),
  t('services.6', { fallback: 'Brand Guidelines' }),
  t('services.7', { fallback: 'User Journey Mapping' }),
  t('services.8', { fallback: 'Interactive UI Elements' }),
  t('services.9', { fallback: 'Motion Design for UI' }),
  t('services.10', { fallback: 'User Interface Development' }),
  t('services.11', { fallback: 'User Engagement Strategy' }),
  t('services.12', { fallback: 'Information Architecture' }),
  t('services.13', { fallback: 'Multilingual Interface Design' }),
];
